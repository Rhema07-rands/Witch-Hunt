...
func draw_debug() -> void:
	...
	draw_string_outline(SystemFont.new(), string_pos, length_string, HORIZONTAL_ALIGNMENT_CENTER, -1, 18, 10, Color.BLACK)         
	draw_string(SystemFont.new(), string_pos, length_string, HORIZONTAL_ALIGNMENT_CENTER, -1, 18, lerped_color, get_weight())                         
