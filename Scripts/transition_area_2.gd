...
@onready var one_way_wall: StaticBody2D = $"One way wall"

@export var level_name := "stage3"
@export var next_level_name := "stage4"
...
func _on_transition_2_body_entered(body: Node2D) -> void:
	if body.name == "Witch":
		...
		get_tree().change_scene_to_file("res://Scenes/victory_screen_2.tscn")
...
func _on_patrick_star_tree_exited() -> void:
	one_way_wall.queue_free()
