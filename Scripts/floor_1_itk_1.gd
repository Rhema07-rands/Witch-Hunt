...
@export var level_name := "stage1"
@export var next_level_name := "stage2"
@onready var what: Label = $"CanvasLayer Fake/Pause Menu Screen/WHAT"
var random_text = ["Ok? What Is It?", "Is There Something You're Longing For?", "But Why Pause Tho?", "Wrap It Up Bro, You're Trash", "Look At You, No Bitches, No Skills"]
...
func _on_area_2d_body_entered(body: Node2D) -> void:
	if body.name == "Witch":
		...
		get_tree().change_scene_to_file("res://Scenes/black_screen14.tscn")
