...
func _on_animated_sprite_2d_frame_changed() -> void:
	if animated_sprite.animation == "attack":
		...
		if current_frame == 1 or current_frame == 3 or current_frame == 5  or current_frame == 7  or current_frame == 9  or current_frame == 11 or current_frame == 13  or current_frame == 15 :
